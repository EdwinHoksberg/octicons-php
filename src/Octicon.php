 ...
 * @method static string heart_outline(array $options = [])
 ...
 * @method static string infinity(array $options = [])
 * @method static string info(array $options = [])
 * @method static string internal_repo(array $options = [])
 ...
 * @method static string line_arrow_down(array $options = [])
 * @method static string line_arrow_left(array $options = [])
 * @method static string line_arrow_right(array $options = [])
 * @method static string line_arrow_up(array $options = [])
 ...
 * @method static string north_star(array $options = [])
